...
function calcular(req, res) {
    ...
    if (idUsuario == undefined) {
        ...
        res.status(400).send("Seu imc está undefined!");
    } else if (salvarResultado == undefined) {
        res.status(400).send("Seu resultado está undefined!");
    }
    else if (atividade == undefined) {
        res.status(400).send("Sua atividade está undefined!");
    } else {
        
        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.calcular(idUsuario, imc, salvarResultado, atividade)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
